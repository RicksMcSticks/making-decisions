...
if(temperature >= 80 && rain === true){
  console.log('wear a t-shirt and take an umbrealla.')
}else if (temperature >= 80 && rain === fasle){
  console.log ('where a t-shirt and dont be bring an umbrella')
}else if(temperature>= 60 && temperature <= 80 && rain === true){
  console.log('wear a jacket')
}else if ('temperature >= 60 && temperature <= 80 && rain === false'){
  console.log('wear a light jacket and no umbrella')
}else {
